...
int main(){
    ...
    for(double photonEnergy=begin;photonEnergy<end;photonEnergy+=step){
        ...
        if((!useIncidentSpin)&&(!useEmissionSpin)&&(!usePolarization)){
            ...
            radiationOfElectron.calculateDifferentialEmissionIntensityWithDoubledLabel();
        ...
        if(useIncidentSpin&&useEmissionSpin&&(!usePolarization)){
            ...
            radiationWithSpinAndPolarzation1.calculateDifferentialEmissionIntensityWithDoubledLabel();
            radiationWithSpinAndPolarzation2.calculateDifferentialEmissionIntensityWithDoubledLabel();
        ...
        if((!useIncidentSpin)&&(!useEmissionSpin)&&usePolarization){
            ...
            radiationWithSpinAndPolarzation1.calculateDifferentialEmissionIntensityWithDoubledLabel();
            radiationWithSpinAndPolarzation2.calculateDifferentialEmissionIntensityWithDoubledLabel();
            radiationWithSpinAndPolarzation3.calculateDifferentialEmissionIntensityWithDoubledLabel();
            radiationWithSpinAndPolarzation4.calculateDifferentialEmissionIntensityWithDoubledLabel();
        ...
        if(useIncidentSpin&&useEmissionSpin&&usePolarization){
            ...
            radiationWithSpinAndPolarzation.calculateDifferentialEmissionIntensityWithDoubledLabel();
